...
<body>
  ...
  <div class="w-full bg-noise lg:w-1/2 flex items-center justify-center">
    <div class="max-w-md w-full p-6">
      ...
      <h1 class="text-sm font-semibold mb-6 text-white text-center">Join to Our Community with all time access and free </h1>
      ...
      <form action="#" method="POST" class="space-y-4">
        ...
        <div>
          ...
          <input type="text" id="username" name="username" class="mt-1 p-2 w-full border border-gray-200  rounded-md focus:bg-gray-300 focus:outline-none focus:text-black focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300 text-white">
        </div>
        <div>
          <label for="email" class="block text-sm font-medium text-white">Email</label>
          <input type="text" id="email" name="email" class="mt-1 p-2 w-full border border-gray-200 rounded-md focus:outline-none focus:bg-gray-300 focus:text-black text-white focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300">
        </div>
        <div>
          <label for="password" class="block text-sm font-medium text-white">Password</label>
          <input type="password" id="password" name="password" class="mt-1 p-2 w-full border border-gray-200 focus:bg-gray-300 text-white focus:text-black rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300">
        </div>
        <div>
          <button type="submit" class="w-full bg-black text-white p-2 rounded-md hover:bg-white hover:text-black focus:outline-none focus:bg-white focus:text-black focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Sign Up</button>
        </div>
      </form>
      <div class="mt-4 text-sm text-white text-center">
        <p>Already have an account? <a href="#" class="text-blue-600 hover:underline">Login here</a>
        </p>
      </div>
    </div>
  </div>
